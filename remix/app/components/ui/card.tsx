...
function Card({
  ...
  return (
    <div
      ...
      className={cn(
        [
          "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-xl bg-transparent",
          "py-(--card-spacing) text-sm text-card-foreground ring-1 ring-blue-500/50",
